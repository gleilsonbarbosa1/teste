...
import { BarChart3, ArrowLeft, User, LogOut, AlertCircle } from 'lucide-react';
...
const Store2ReportsPage: React.FC = () => {
  ...
  // Se estiver autenticado, mostrar relatórios
  return (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Elite Açaí - Análises e Relatórios</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-600 mb-2">
            Relatórios da Loja 2 em Desenvolvimento
          </h3>
          <p className="text-gray-500">
            Esta funcionalidade está sendo desenvolvida. Em breve você terá acesso aos relatórios específicos da Loja 2.
          </p>
        </div>
      </div>
    </div>
