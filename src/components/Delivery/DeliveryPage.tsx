    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed bottom-6 left-6 z-50 flex flex-col gap-3">
        ...
        <button
          ...
          className="bg-purple-500 hover:bg-purple-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center"
      ...
      {selectedProduct && (
        <ProductModal
          ...
          onAddToCart={(product, selectedSize, quantity, observations, selectedComplements) => {
            if (editingCartItem) {
              // Modo edição: remover item antigo e adicionar novo
